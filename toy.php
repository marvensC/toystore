<?php   										// Opening PHP tag
	...
	/*
	 * TO-DO: Define a function that retrieves ALL toy and manuf info from the database based on the toynum parameter from the URL query string.
	 		  - Write SQL query to retrieve ALL toy and manuf info based on toynum
	...
	function get_toy_info(PDO $pdo, string $id) {
		...
		// Execute the SQL query using the pdo function and fetch the result
		return pdo($pdo, $sql, ['id' => $id])->fetch();	// Associative array where 'id' is the key and $id is the value. Used to bind the value of $id to the placeholder :id in  SQL query.
	}
